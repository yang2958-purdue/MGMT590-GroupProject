...
.venv\Scripts\python.exe -m pip install -q --no-deps "python-jobspy>=1.1.0"
.venv\Scripts\python.exe -m pip install -q --upgrade "numpy>=2.0" "pandas>=2.2" tls-client regex markdownify "pydantic>=2.0"
